...
class ProfitAndLoss extends owl.Component {
    ...
    async load_data() {
        ...
        try {
            ...
            let accounts = await self.orm.call("dynamic.balance.sheet.report", "custom_view_report",   [this.wizard_id] );

            console.log("📦 custom_view_report raw data from backend:", accounts);
...
ProfitAndLoss.template = 'custom_dfr_template_new';
actionRegistry.add("custom_dfr_n", ProfitAndLoss);